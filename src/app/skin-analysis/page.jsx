  ...
  return (
    <div className="flex flex-col h-screen bg-black">
      ...
      <div className="flex-1 relative">
        ...
        {/* Analysis Controls */}
        {mirrorCalibrated && !analyzing && !analysis && (
          <div className="absolute top-4 right-4 bg-[#1a1a1a] p-6 rounded-xl border border-[#333] shadow-lg">
            ...
            <button
              onClick={analyzeSkin}
              className="w-full bg-[#357AFF] text-white py-3 px-6 rounded-lg font-medium hover:bg-[#2563EB] transition-colors"
            >
              Start Analysis
            </button>
          </div>
          ...
          <div className="absolute left-4 top-4 bg-[#1a1a1a] p-6 rounded-xl border border-[#333] shadow-lg max-w-md">
            ...
            {analyzing ? (
              <div className="flex items-center text-white">
                <div className="animate-spin rounded-full h-6 w-6 border-2 border-[#357AFF] border-t-transparent mr-3"></div>
              ...
              <div className="space-y-4 text-white">
                ...
                <button
                  ...
                  className="mt-4 w-full bg-[#2a2a2a] text-white py-2 rounded-lg hover:bg-[#333] transition-colors"
                >
                  New Analysis
                </button>
              </div>
        ...
        {/* Error Display */}
        {error && (
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-red-500 bg-opacity-90 p-4 rounded-lg text-white flex items-center gap-3">
